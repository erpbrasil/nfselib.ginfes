...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/erpbrasil/nfselib.ginfes/ginfeslib/v3_01/servico_consultar_situacao_lote_rps_envio.py')
#
# Command line arguments:
#   /tmp/generated/schemas/ginfes/v3_01/servico_consultar_situacao_lote_rps_envio_v03.xsd
#
# Command line:
#   /home/mileo/Projects/erpbrasil/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/home/mileo/Projects/erpbrasil/nfselib.ginfes/ginfeslib/v3_01/servico_consultar_situacao_lote_rps_envio.py" /tmp/generated/schemas/ginfes/v3_01/servico_consultar_situacao_lote_rps_envio_v03.xsd
#
...
class ConsultarSituacaoLoteRpsEnvio(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('Id', 'tipos:tsIdTag', 0, 1, {'use': 'optional'}),
    ...
    subclass = None
    superclass = None
    def __init__(self, Id=None, Prestador=None, Protocolo=None, Signature=None, gds_collector_=None, **kwargs_):
    ...
    def validate_tsIdTag(self, value):
        # Validate type tipos:tsIdTag, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_situacao_lote_rps_envio import *\n\n')
        sys.stdout.write('import servico_consultar_situacao_lote_rps_envio as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.ginfes.com.br/servico_consultar_situacao_lote_rps_envio_v03.xsd': [],
