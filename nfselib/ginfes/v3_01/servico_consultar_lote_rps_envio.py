...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/erpbrasil/nfselib.ginfes/ginfeslib/v3_01/servico_consultar_lote_rps_envio.py')
#
# Command line arguments:
#   /tmp/generated/schemas/ginfes/v3_01/servico_consultar_lote_rps_envio_v03.xsd
#
# Command line:
#   /home/mileo/Projects/erpbrasil/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/home/mileo/Projects/erpbrasil/nfselib.ginfes/ginfeslib/v3_01/servico_consultar_lote_rps_envio.py" /tmp/generated/schemas/ginfes/v3_01/servico_consultar_lote_rps_envio_v03.xsd
#
...
class TransformType(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('XPath', 'xsd:string', 1, 1, {'name': 'XPath', 'type': 'xsd:string'}, 1),
        MemberSpec_('valueOf_', [], 0),
    ]
    subclass = None
    superclass = None
...
class KeyInfoType(GeneratedsSuper):
    ...
    member_data_items_ = [
        MemberSpec_('Id', 'ID', 0, 1, {'use': 'optional'}),
        MemberSpec_('KeyName', 'xsd:string', 1, 0, {'name': 'KeyName', 'ref': 'KeyName', 'type': 'KeyName'}, 2),
        MemberSpec_('KeyValue', 'KeyValueType', 1, 0, {'name': 'KeyValue', 'ref': 'KeyValue', 'type': 'KeyValue'}, 2),
        MemberSpec_('RetrievalMethod', 'RetrievalMethodType', 1, 0, {'name': 'RetrievalMethod', 'ref': 'RetrievalMethod', 'type': 'RetrievalMethod'}, 2),
        MemberSpec_('X509Data', 'X509DataType', 1, 0, {'name': 'X509Data', 'ref': 'X509Data', 'type': 'X509Data'}, 2),
        MemberSpec_('PGPData', 'PGPDataType', 1, 0, {'name': 'PGPData', 'ref': 'PGPData', 'type': 'PGPData'}, 2),
        MemberSpec_('SPKIData', 'SPKIDataType', 1, 0, {'name': 'SPKIData', 'ref': 'SPKIData', 'type': 'SPKIData'}, 2),
        MemberSpec_('MgmtData', 'xsd:string', 1, 0, {'name': 'MgmtData', 'ref': 'MgmtData', 'type': 'MgmtData'}, 2),
        MemberSpec_('__ANY__', '__ANY__', 0, 0, {'namespace': '##other', 'processContents': 'lax'}, None),
        MemberSpec_('valueOf_', [], 0),
    ]
    subclass = None
...
class KeyValueType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('DSAKeyValue', 'DSAKeyValueType', 0, 0, {'name': 'DSAKeyValue', 'ref': 'DSAKeyValue', 'type': 'DSAKeyValue'}, 3),
        MemberSpec_('RSAKeyValue', 'RSAKeyValueType', 0, 0, {'name': 'RSAKeyValue', 'ref': 'RSAKeyValue', 'type': 'RSAKeyValue'}, 3),
        MemberSpec_('__ANY__', '__ANY__', 0, 0, {'namespace': '##other', 'processContents': 'lax'}, None),
        MemberSpec_('valueOf_', [], 0),
    ]
    subclass = None
...
class X509DataType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('X509IssuerSerial', 'X509IssuerSerialType', 1, 0, {'maxOccurs': 'unbounded', 'name': 'X509IssuerSerial', 'type': 'X509IssuerSerialType'}, 4),
        MemberSpec_('X509SKI', 'xsd:string', 1, 0, {'maxOccurs': 'unbounded', 'name': 'X509SKI', 'type': 'xsd:string'}, 4),
        MemberSpec_('X509SubjectName', 'xsd:string', 1, 0, {'maxOccurs': 'unbounded', 'name': 'X509SubjectName', 'type': 'xsd:string'}, 4),
        MemberSpec_('X509Certificate', 'xsd:string', 1, 0, {'maxOccurs': 'unbounded', 'name': 'X509Certificate', 'type': 'xsd:string'}, 4),
        MemberSpec_('X509CRL', 'xsd:string', 1, 0, {'maxOccurs': 'unbounded', 'name': 'X509CRL', 'type': 'xsd:string'}, 4),
        MemberSpec_('__ANY__', '__ANY__', 0, 0, {'namespace': '##other', 'processContents': 'lax'}, None),
    ]
    subclass = None
    superclass = None
...
class PGPDataType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('PGPKeyID', 'xsd:string', 0, 0, {'name': 'PGPKeyID', 'type': 'xsd:string'}, 5),
        MemberSpec_('PGPKeyPacket', 'xsd:string', 0, 0, {'name': 'PGPKeyPacket', 'type': 'xsd:string'}, 5),
        MemberSpec_('__ANY__', '__ANY__', 1, 1, {'maxOccurs': 'unbounded', 'minOccurs': '0', 'namespace': '##other', 'processContents': 'lax'}, None),
    ]
    subclass = None
    superclass = None
...
class tcCpfCnpj(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Cpf', ['tsCpf', 'xsd:string'], 0, 1, {'minOccurs': '0', 'name': 'Cpf', 'type': 'xsd:string'}, 7),
        MemberSpec_('Cnpj', ['tsCnpj', 'xsd:string'], 0, 1, {'minOccurs': '0', 'name': 'Cnpj', 'type': 'xsd:string'}, 7),
    ]
    subclass = None
    superclass = None
...
NamespaceToDefMappings_ = {'http://www.ginfes.com.br/servico_consultar_lote_rps_envio_v03.xsd': [],
