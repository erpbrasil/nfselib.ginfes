...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/erpbrasil/nfselib.ginfes/ginfeslib/v3_01/servico_consultar_situacao_lote_rps_resposta.py')
#
# Command line arguments:
#   /tmp/generated/schemas/ginfes/v3_01/servico_consultar_situacao_lote_rps_resposta_v03.xsd
#
# Command line:
#   /home/mileo/Projects/erpbrasil/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/home/mileo/Projects/erpbrasil/nfselib.ginfes/ginfeslib/v3_01/servico_consultar_situacao_lote_rps_resposta.py" /tmp/generated/schemas/ginfes/v3_01/servico_consultar_situacao_lote_rps_resposta_v03.xsd
#
...
class ConsultarSituacaoLoteRpsResposta(GeneratedsSuper):
    ...
    member_data_items_ = [
        ...
        MemberSpec_('ListaMensagemRetorno', 'ListaMensagemRetorno', 0, 0, {'maxOccurs': '1', 'minOccurs': '1', 'name': 'ListaMensagemRetorno', 'ref': 'ListaMensagemRetorno', 'type': 'ListaMensagemRetorno'}, 1),
    ]
    subclass = None
    superclass = None
    ...
    def validate_tsSituacaoLoteRps(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if not self.gds_validate_simple_patterns(
                ...
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_tsSituacaoLoteRps_patterns_, ))
                result = False
        return result
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='ConsultarSituacaoLoteRpsResposta', fromsubclass_=False, pretty_print=True):
        ...
        if self.ListaMensagemRetorno is not None:
            ...
            self.ListaMensagemRetorno.export(outfile, level, namespaceprefix_='tipos:', namespacedef_='', name_='ListaMensagemRetorno', pretty_print=pretty_print)
...
class tcCpfCnpj(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    member_data_items_ = [
        MemberSpec_('Cpf', ['tsCpf', 'xsd:string'], 0, 1, {'minOccurs': '0', 'name': 'Cpf', 'type': 'xsd:string'}, 2),
        MemberSpec_('Cnpj', ['tsCnpj', 'xsd:string'], 0, 1, {'minOccurs': '0', 'name': 'Cnpj', 'type': 'xsd:string'}, 2),
    ]
    subclass = None
    superclass = None
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_consultar_situacao_lote_rps_resposta import *\n\n')
        sys.stdout.write('import servico_consultar_situacao_lote_rps_resposta as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.ginfes.com.br/servico_consultar_situacao_lote_rps_resposta_v03.xsd': [],
