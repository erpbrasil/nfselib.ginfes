...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/erpbrasil/nfselib.ginfes/ginfeslib/v3_01/servico_cancelar_nfse_envio.py')
#
# Command line arguments:
#   /tmp/generated/schemas/ginfes/v3_01/servico_cancelar_nfse_envio_v03.xsd
#
# Command line:
#   /home/mileo/Projects/erpbrasil/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/home/mileo/Projects/erpbrasil/nfselib.ginfes/ginfeslib/v3_01/servico_cancelar_nfse_envio.py" /tmp/generated/schemas/ginfes/v3_01/servico_cancelar_nfse_envio_v03.xsd
#
...
class CancelarNfseEnvio(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Pedido=None, Signature=None, gds_collector_=None, **kwargs_):
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from servico_cancelar_nfse_envio import *\n\n')
        sys.stdout.write('import servico_cancelar_nfse_envio as model_\n\n')
...
NamespaceToDefMappings_ = {'http://www.ginfes.com.br/servico_cancelar_nfse_envio_v03.xsd': [],
